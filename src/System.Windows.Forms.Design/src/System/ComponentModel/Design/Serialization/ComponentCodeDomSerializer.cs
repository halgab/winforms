...
internal class ComponentCodeDomSerializer : CodeDomSerializer
{
    ...
    internal static new ComponentCodeDomSerializer Default
    {
        get
        {
            if (s_defaultSerializerRef is not null && s_defaultSerializerRef.TryGetTarget(out ComponentCodeDomSerializer? defaultSerializer))
            {
            ...
            {
                s_defaultSerializerRef = new WeakReference<ComponentCodeDomSerializer>(defaultSerializer);
            }
            else
            {
